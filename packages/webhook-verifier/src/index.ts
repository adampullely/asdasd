 ...
 * signature verifier for MyApp outbound webhook deliveries.
 *
...
/**
 * Compute the canonical MyApp webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a MyApp webhook delivery.
 *

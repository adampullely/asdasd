...
//   - `~/.config/asdasd/credentials.json` (0600)
//   - `~/.config/asdasd/config.json`     (0644)
//
// Override via `ASDASD_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/asdasd` everywhere

// `asdasd webhook verify` — local cryptographic verification of a
// MyApp outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `asdasd login`.

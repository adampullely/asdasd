...
// `@saas/sdk` client class name (`MyApp`) is intentionally NOT part of
...
export const CLI_BIN = "asdasd";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "My App";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.myapp.dev";

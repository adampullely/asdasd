// Typed error hierarchy for the MyApp SDK.
//
...
// codes (forward compatibility) fall back to the generic `MyAppError`
...
export interface MyAppErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof MyAppError`
 * still matches.
 */
export class MyAppError extends Error {
  ...
  constructor(init: MyAppErrorInit) {
...
export class BadRequestError extends MyAppError {
  constructor(init: MyAppErrorInit) {
    super(init);
...
export class UnauthenticatedError extends MyAppError {
  constructor(init: MyAppErrorInit) {
    super(init);
...
export class ConflictError extends MyAppError {
  constructor(init: MyAppErrorInit) {
    super(init);
...
export class ValidationError extends MyAppError {
...
export class PreconditionFailedError extends MyAppError {
  constructor(init: MyAppErrorInit) {
    super(init);
...
export class UnsupportedError extends MyAppError {
  constructor(init: MyAppErrorInit) {
    super(init);
...
export class InternalError extends MyAppError {
  constructor(init: MyAppErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends MyAppErrorInit {
...
export class RateLimitError extends MyAppError {
...
/**
 * Decode an HTTP `Response` into the appropriate `MyAppError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `MyAppError`.

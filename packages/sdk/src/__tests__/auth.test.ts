...
//   - MyAppError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): MyApp {
  return new MyApp({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the MyApp class", () => {
